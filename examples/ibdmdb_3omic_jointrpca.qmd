...
# Build a MultiAssayExperiment with identical sample IDs 
...
mae_3 <- MultiAssayExperiment::MultiAssayExperiment(
  experiments = MultiAssayExperiment::ExperimentList(
    list(view_MGX = se_mgx, view_MTX = se_mtx, view_VRX = se_vrx)
  )
)

#ensure they still share identical sample IDs inside MAE
mae_3 <- MultiAssayExperiment::intersectColumns(mae_3)
stopifnot(
  length(intersect(
    colnames(SummarizedExperiment::assay(mae_3[["view_MGX"]], "counts")),
    colnames(SummarizedExperiment::assay(mae_3[["view_MTX"]], "counts"))
  )) == length(shared_3),
  length(intersect(
    colnames(SummarizedExperiment::assay(mae_3[["view_MGX"]], "counts")),
    colnames(SummarizedExperiment::assay(mae_3[["view_VRX"]], "counts"))
  )) == length(shared_3)
)
