...
se_vrx <- SummarizedExperiment(assays = list(counts = X_vrx), colData = cd)

mae_3 <- MultiAssayExperiment(
experiments = ExperimentList(list(MGX = se_mgx, MTX = se_mtx, VRX = se_vrx))
)
mae_3 <- intersectColumns(mae_3)
mae_3
...
100prop[1], 100prop[2], 100*prop[3]))
}
