...
U <- as.data.frame(fit$ord.res$samples)     #samples x components
V_16S <- as.data.frame(fit$ord.res$features) #features x components
...
#log-ratio (PC1 top vs bottom features)
