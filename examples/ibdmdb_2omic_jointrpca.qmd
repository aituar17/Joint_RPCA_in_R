...
head(dplyr::inner_join(
  data.frame(sample_id = tolower(U$sample_id)),
  transform(meta_df, across(everything(), ~ tolower(trimws(as.character(.))))),
  by = c("sample_id" = "<PUT_THE_CHOSEN_META_COLUMN_NAME_HERE>")
))
