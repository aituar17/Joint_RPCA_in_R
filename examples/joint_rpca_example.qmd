...
results_df <- data.frame(
  Method = c("Joint-RPCA", "Per-layer RPCA", "Raw rCLR-Transformed Features (Per Omic)", "Random"),
  Accuracy = c(res_joint$accuracy, res_rpca$accuracy, res_rclr$accuracy, res_random$accuracy),
  AUC = c(res_joint$auc, res_rpca$auc, res_rclr$auc, res_random$auc)
)
