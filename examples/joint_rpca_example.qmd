...
dir.create("interop", showWarnings = FALSE)

for (i in seq_along(rclr_list)) {
  fn <- file.path("interop", sprintf("view_%d_rclr.tsv", i))
...
cat("Exported to", normalizePath("interop"), "\n",
    "views:", length(rclr_list), "\n",
