...
common_samples <- Reduce(intersect, lapply(mofa_data, rownames))
mofa_data <- lapply(mofa_data, function(tbl) tbl[common_samples, ])
...
labels_mofa <- labels[rownames(features_mofa)]
