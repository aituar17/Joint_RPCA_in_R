...
features_rclr_concat <- do.call(cbind, lapply(result$rclr.tables, function(tbl) tbl[common_samples, ]))
...
results_df <- data.frame(
  Method = c("Joint-RPCA", "Raw rCLR-Transformed Features", "Per-layer PCA", "Per-layer RPCA", "Random"),
  Accuracy = c(res_joint$accuracy, res_rclr$accuracy, res_pca$accuracy, res_rpca$accuracy, res_random$accuracy),
  AUC = c(res_joint$auc, res_rclr$auc, res_pca$auc, res_rpca$auc, res_random$auc)
)

print(results_df)

print(result$ord.res$samples)
print(result$rclr.tables)
print(features_rclr_concat)
print(features_pca_concat)
print(features_rpca_concat)
print(dataset_specific_scores)
