...
results_df <- data.frame(
  Method = c("Joint-RPCA", "Per-layer PCA", "Per-layer RPCA", "Random"),
  Accuracy = c(res_joint$accuracy, res_pca$accuracy, res_rpca$accuracy, res_random$accuracy),
  AUC = c(res_joint$auc, res_pca$auc, res_rpca$auc, res_random$auc)
)
