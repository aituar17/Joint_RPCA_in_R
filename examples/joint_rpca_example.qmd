...
cat("Concatenated rCLR dims BEFORE filter:", 
    nrow(features_rclr_concat), "x", ncol(do.call(cbind, X_list)), "\n")
cat("Concatenated rCLR dims AFTER filter:", 
    nrow(features_rclr_concat), "x", ncol(features_rclr_concat), "\n")
